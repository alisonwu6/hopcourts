      ...
      <main className="mx-auto w-full max-w-2xl px-4 py-8">
        <article className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8">
          ...
          <div className="mt-6 space-y-6 text-base leading-8 text-slate-700">
            ...
            <p>
              You might have the time. You might have the court. But somehow the game never
              happens.
            </p>
            <p>
              We wait in group chats. We try new communities. Sometimes we just give up and go
              home.
            </p>
            <p>Something that should feel natural starts to feel complicated.</p>
            <p>But sport was never meant to be complicated.</p>
            <p>
              In many places around the world, all it takes is someone bringing a ball to a court.
              And slowly, people gather.
            </p>
            <p>
              Strangers start playing together. Different backgrounds meet through the same language
              — movement.
            </p>
            <p>For a moment, it feels like a small Olympic village inside a city.</p>
            <p>
              Everyone arrives with their own rhythm. Some want to compete. Some want to move. Some
            ...
            <p>
              ...
              your phone and find people ready to move — whatever sport you love.
            </p>
