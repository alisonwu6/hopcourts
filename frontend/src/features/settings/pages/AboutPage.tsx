  ...
  return (
    <div className="min-h-[100dvh] bg-[#edf4ed] text-[#1a3320]">
      ...
      <section className="px-5 pb-8 pt-8">
        ...
        <p className="mt-5 text-base leading-relaxed text-courts">
          New to a city or just can&apos;t find people who are into the same sports — we get it. HopCourts was built to
          fix that.
        </p>
        <p className="mt-3 text-base leading-relaxed text-courts">
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className={i < steps.length - 1 ? 'pb-6' : 'pb-0'}>
                ...
                <p className="mt-1 text-sm leading-relaxed text-courts">{step.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="px-5 pb-10">
        <div className="rounded-3xl bg-[#1a3320] px-6 py-7">
          <p className="text-[1.45rem] font-black leading-snug tracking-tight text-[#8cc87a]">
            &ldquo;We use code to remove the coordination problem — not to pull you deeper into your phone.&rdquo;
          </p>
        </div>
      </section>
    </div>
