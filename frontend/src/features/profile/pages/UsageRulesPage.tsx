      ...
      <div className="mx-auto w-full max-w-3xl px-4 py-8">
        <div className="space-y-8 text-base leading-relaxed text-slate-600">
          ...
          <section>
            ...
            <p>
              Use your real identity and treat others with respect and fairness. Harassment,
              discrimination, abuse, or inappropriate behavior may lead to account restrictions or
              termination.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Before attending, confirm that the venue is appropriate and safe for the activity.
              Venue rules and fees are determined by the venue provider.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Participating in the same session doesn’t mean you know each other personally. Please
