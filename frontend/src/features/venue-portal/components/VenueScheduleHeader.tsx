  ...
  const rightAction =
    viewMode === 'template' && onSync ? (
      <button
        onClick={onSync}
        disabled={saving}
        className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-[#2f6d16] transition-opacity hover:opacity-70 disabled:opacity-30"
      >
