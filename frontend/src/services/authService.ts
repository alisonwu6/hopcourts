...
export const authService = {
  ...
  async completeOnboarding(onboardingData: Partial<OnboardingStatus>): Promise<SignInResponse> {
    storedStatus = {
      ...
      hasPlayingStyle: onboardingData.hasPlayingStyle ?? storedStatus.hasPlayingStyle,
      hasPlayFrequency: onboardingData.hasPlayFrequency ?? storedStatus.hasPlayFrequency,
      hasAvatar: onboardingData.hasAvatar ?? storedStatus.hasAvatar,
      hasMotivation: onboardingData.hasMotivation ?? storedStatus.hasMotivation,
      hasVenueDetails: onboardingData.hasVenueDetails ?? storedStatus.hasVenueDetails,
      hasVenueSports: onboardingData.hasVenueSports ?? storedStatus.hasVenueSports,
      hasVenueCourts: onboardingData.hasVenueCourts ?? storedStatus.hasVenueCourts,
      hasVenuePhoto: onboardingData.hasVenuePhoto ?? storedStatus.hasVenuePhoto,
      hasVenueVerification: onboardingData.hasVenueVerification ?? storedStatus.hasVenueVerification,
      isComplete: true,
    }
    if (storedUser) {
      storedUser = {
