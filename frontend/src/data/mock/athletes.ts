...
export const mockAthletes: AthleteCardProps[] = [
  ...
  },
  {
    ...
    avatarUrl: '/mock/athletes/alex.png',
    coverUrl: '/mock/covers/court.jpg',
    stats: { sessions: 24, streakWeeks: 6, energy: 82, badges: 3 },
    ...
    visibility: 'public',
    relationship: { sessionsTogether: 12 },
    statusLabel: 'active',
    activeNow: true,
    highFiveCount: 24,
  },
  {
    ...
    stats: { sessions: 15, streakWeeks: 0, energy: 58, badges: 1 },
    tags: ['Climbing', 'ChillVibes', 'CoffeeAfter'],
    vibes: ['Climbing', 'CoffeeAfter'],
    bio: 'Belay buddy · loves dawn climbs · still learning dynos.',
    recentActivities: [
      { id: 's4', title: 'Kangaroo Point Session', sport: 'Climbing', time: '2025-09-28T06:00:00Z', partners: ['Keira'], stats: { highFives: 4 } },
    ],
    visibility: 'smart',
    relationship: { sessionsTogether: 3 },
    statusLabel: 'rest',
  ...
  },
  {
    ...
    stats: { sessions: 8, streakWeeks: 1, energy: 35, badges: 0 },
